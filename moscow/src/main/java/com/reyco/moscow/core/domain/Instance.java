...
public class Instance implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3846624661034225101L;
	...
	public Long getInstanceHeartBeatTimeOut() {
		return BeatType.SERVICE_BEAT_TIMEOUT_UNHEALTHY.getTime();
	}
	public long getIpDeleteTimeout() {
		return BeatType.SERVICE_BEAT_TIMEOUT_DELETE.getTime();
	}
}
